  ...
  <html lang="en">
    ...
    data?.custMobileNo
      ...
      <span class="mt-5 block"
        ><span class="bold">Subject: </span> Intimation of issuance of Warrants in
        legal action taken by HDFC Bank U/s 25C of PASA, 2007 / Sec138 of N.I.
        Act,1881 with respect to your HDFC Bank
        <span class="bold"
          >Credit Card No.${data?.maskCard} (AAN# ${data?.aan})</span
        >
      </span>
      ...
      <br />
      <span
        >That you had availed credit card facility from my client vide
        <span class="bold"
          >Credit Card No. ${data?.maskCard} (AAN# ${data?.aan}.</span
        ></span
      >
      ...
      <br />
      <span
        >That you failed to adhere to the terms and conditions of the card member
      ...
      <span
        ...
        outstanding dues of credit card, my client (‘HDFC Bank’) has initiated
        legal action U/s 25 C of PASA Act and or U/s 138 of Negotiable Instrument
        Act before the court of competent jurisdiction at District Court
        <span class="bold">«COURT_DETAILS»</span>,
        <span class="bold">«Court_Place»</span> (State)</span
      >
      ...
      <span
        ...
        between 10.00 AM to 5.00 PM on all working days.
      </span>
      ...
      <span
        ...
        available to our client under the card member agreement. Kindly ignore the
