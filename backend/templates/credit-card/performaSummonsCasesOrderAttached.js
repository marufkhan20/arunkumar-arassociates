module.exports = (data) =>
  ...
  <html lang="en">
    ...
    <body style="padding: 100px 90px; background-color: white">
      ...
      <br />
      <span
        >That you had availed credit card facility from my client vide Credit Card
        <span class="bold">No. ${data?.maskCard} (AAN# ${data?.aan}.</span></span
      >
      ...
      <span
        ...
        <span class="bold">«COURT_DETAILS», «Court_Place» (State).</span></span
      >
