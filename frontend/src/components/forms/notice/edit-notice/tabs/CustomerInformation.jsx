...
const CustomerInformation = ({
  ...
  useEffect(() => {
    if (noticeData?._id) {
      setConciliationDate(noticeData?.conciliationDate);
      setNoticeSentOn(noticeData?.noticeSentOn);
      setUniqueId(noticeData?.uniqueId);
      setAllocationDate(noticeData?.allocationDate);
      setLegalCaseId(noticeData?.legalCaseId);
      setMailId(noticeData?.mailId);
      setMobile(noticeData?.mobile);
      setLegalManager(noticeData?.legalManager);
      setRemark(noticeData?.remark);
      setModeOfDispatch(noticeData?.modeOfDispatch);
    }
  }, [noticeData]);
