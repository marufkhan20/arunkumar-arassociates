...
const Information = ({
  ...
  useEffect(() => {
    if (noticeData?._id) {
      setLoanNo(noticeData?.loanNo);
      setArqnName(noticeData?.arqnName);
      setProduct(noticeData?.product);
      setBranchAdd(noticeData?.branchAdd);
      setState(noticeData?.state);
      setRegion(noticeData?.region);
      setCallManager(noticeData?.callManager);
      setClmMob(noticeData?.clmMob);
      setNpaStage(noticeData?.npaStage);
    }
  }, [noticeData]);
