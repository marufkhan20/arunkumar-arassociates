...
const Address = ({ activeTab, setActiveTab, setDataHandler, noticeData }) => {
  ...
  useEffect(() => {
    if (noticeData?._id) {
      setAmtfin(noticeData?.amtfin);
      setEmi(noticeData?.emi);
      setTenture(noticeData?.tenture);
      setDisbDate(noticeData?.disbDate);
      setTotalDue(noticeData?.totalDue);
      setAddress(noticeData?.address);
      setCustomerName2(noticeData?.customerName2);
      setAddress3(noticeData?.address3);
      setAddress4(noticeData?.address4);
    }
  }, [noticeData]);
