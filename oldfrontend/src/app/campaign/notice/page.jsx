...
import { useGetCampaignsQuery } from "@/features/campaign/campaignApi";
...
const NoticePage = () => {
  ...
  const { data: campaigns, isLoading } = useGetCampaignsQuery("notice");
        ...
        {campaigns
          ...
          .map((campaign, idx) => (
            <>
              ...
              <Link
                href={`/campaign/notice/${campaign?._id}`}
